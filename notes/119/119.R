...
smcr(mp_mean_int, mp_mean_con, mp_sd_int, mp_sd_con, mp_n, 0.5, exact = FALSE)
# perfect match
...
# use repeated measures ES
o <- smcr(mp_mean_int, mp_mean_con, mp_sd_int, mp_sd_con, mp_n, mp_r, exact = FALSE)
o$es <- hrm
o |> get_ci()
# almost matching
...
# So I cannot fully reproduce the ES confidence interval because I cannot see 
# how the SE was calculated with the online calculator
# this also means I cannot really verify that the correlation is actually r=0.5