...
Daniel Memmert^1^, Jennifer Murphy^2^, Simon Nolte^1,3^, Oliver Jan Quittmann^3^, Robert Rein^1^, Theresa Siepe^3^

^1^Institute of Exercise Training and Sport Informatics, German Sport University Cologne ^2^Department of Sport Exercise and Nutrition, Atlantic Technological University, Galway, Ireland ^3^Institute of Movement and Neurosciences, German Sport University Cologne
...
To date, no systematic review exists of the methods used to determine effect sizes in published exercise intervention meta-analyses. Since different analytical methods can lead to varying conclusions [@fu2016], the use of a variety of methods may indicate a lack of robustness in many meta-research findings within exercise science. A systematic review, coupled with a review of available methodological literature, could provide valuable recommendations for sports scientists when calculating effect sizes in exercise intervention meta-analyses.
...
-   Criteria/assessment of baseline imbalances for studies included in the meta-analysis. Whether the meta-analyis only included randomized controlled trials, or included all trials but rated the randomization procedure (e.g., via the PEDRO scale), or did not discuss randomization of included studies at all.
...
When they later encounter errors in their screening, researchers can update their screening results. This will restart the screening process for the respective article. Due to technical reasons, only the latest update is documented.
...
For the case study, we use the article by @oliveira2024, as it matches our inclusion criteria and is an exemplary example for meta-analyses of exercise interventions with a two-group pre-post design. In this regard, it features typical properties of exercise meta-analyses with a rather low number of studies (≈10) included and a rather low median sample size per group (≈12).
