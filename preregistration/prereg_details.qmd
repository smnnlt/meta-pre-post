...
Initial search results will be stored in a csv file containing data about XYZ. Results of screening and data extraction will be stored in the database and will be later exported. All data and analysis code will be made publicly available under a XYZ license on GitHub repository.
...
The researcher performing the validation is blinded to who performed the data extraction. For the subset of studies that undergo an extraction reliability check, both extractors will work independently.
...
For the case study, we use the article by @oliveira2024, as it matches our inclusion criteria and stands examplary for meta-analyses of exercise interventions with a two-group pre-post design.
